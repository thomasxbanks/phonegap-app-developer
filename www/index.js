...
const populate = () => {
  const content = [
    `<div class="cutaway" style="max-width: 50%; height: calc(100vh - 2rem);"><video playsinline loop muted poster="./images/Stat_01.png"><source src="./videos/Stat_01.mp4" type="video/mp4"><source src="./videos/Stat_01.mov" type="video/mov">Your browser does not support the video tag.</video></div>`,
